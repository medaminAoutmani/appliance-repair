      ...
      <CarouselContent className="">
        <CarouselItem className="flex items-center justify-center lg:justify-end w-56 lg:w-28 xl:w-36 mt-5 pl-10 md:mt-5 lg:mr-8 xl:mr-14 ">
          <div className="p-1 pb-5">
            <Image key="logo1" src="/LG.svg" className="w-[60px] lg:w-[70px] xl:w-[70px]" width={100} height={100} alt="Logo" />

          </div>
        </CarouselItem>
        <CarouselItem className="flex items-center justify-center w-56 mr-2 mt-6  ">
          <div className="p-1 ml-6 pb-5">
            <Image key="logo2" src="/samsung.svg" className="w-[170px] lg:w-[170px] xl:w-[210px]" width={190} height={100} alt="Logo" />
          </div>
        </CarouselItem>
        ...
        <CarouselItem className="flex items-center justify-end w-56 mr-0 lg:mr-4 xl:mr-0 ">
          <div className="p-1 mr-0 lg:mr-6">
            <Image key="logo5" src="/bosch.svg" className="lg:mr-2 w-[140px] lg:w-[140px] xl:w-[160px]" width={200} height={120} alt="Logo" />
          </div>
        </CarouselItem>
      </CarouselContent>
