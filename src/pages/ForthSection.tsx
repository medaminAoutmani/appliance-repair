  ...
  return (
    <section className='w-full h-full flex flex-col items-center justify-center pb-10 lg:pb-[100px] pt-28 md:pt-32 '>
      <div className=' relative h-full w-full lg:w-[90%] xl:w-[79%] flex flex-col items-center justify-center px-2 sm:px-0' >
        <div className={`flex ${language == 'en' ? 'flex-col sm:flex-row ' : 'flex-col '} items-center  text-center gap-2 justify-center mb-0 lg:mb-5 font-lato text-wrap text-3xl sm:text-[28px] md:text-[32px] lg:text-4xl xl:text-5xl font-semibold sm:font-bold xl:font-extrabold text-[#1c1f48]`}>
          <div className='flex items-center justify-center sm:flex-row flex-wrap gap-0 md:gap-1 lg:gap-2'>
            {t('forthSection.discover')}
            <div className="bg-gradient-to-r text-wrap sm:text-nowrap from-[#08ac86] via-[#136369] to-[#193351] bg-clip-text text-transparent mx-1">
